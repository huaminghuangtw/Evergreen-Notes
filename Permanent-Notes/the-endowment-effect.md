...
This bias makes us resistant to change and overly attached to the [status quo](the-present-bias.md), even when better options exist.

---

[@kahnemanExperimentalTestsEndowment1990]
...
This revealed a striking cognitive bias: [The Endowment Effect](https://www.google.com/search?q=The+Endowment+Effect).
...
* You keep old clothes you never wear simply because they’re already in your closet.
* People are reluctant to sell a house at a loss, even if it’s the rational choice, because they “own” it.
* Companies overvalue patents or products they developed, even when the market says otherwise.

# Related Biases

* [Loss Aversion](loss-aversion.md)
* [Status Quo Bias](the-present-bias.md)
* [Sunk Cost Fallacy](the-sunk-cost-fallacy.md)
* [Anchoring Effect](the-anchoring-effect.md)

# How to Overcome

* Imagine you don’t own the item: Would you buy it again at the current price?
* Seek outside perspectives—ask what a neutral third party would do.
* Practice [detachment](dispel-your-narratives.md): Remind yourself that value is not inherent, but assigned.
* Use [probabilistic thinking](probabilistic-thinking.md): Consider the odds that keeping something will actually benefit you in the future.
