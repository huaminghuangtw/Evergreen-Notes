...
* Instead of treating AI as an intern, treat it like an infinitely patient coworker who:
...
* Keyboard Shortcuts
	* Open/Hide Copilot Chat: <kbd>Ctrl</kbd> + <kbd>Cmd</kbd> + <kbd>I</kbd>
	* Open/Hide Copilot Edits: <kbd>Shift</kbd> + <kbd>Cmd</kbd> + <kbd>I</kbd>
	* Open Editor Inline Chat: <kbd>Cmd</kbd> + <kbd>I</kbd>
	* Commands
		* Type `#` to add context (e.g., `#file`, `#folder`, etc.)
		* Type `/` to use commands (e.g, `/explain`, `/fix`, `/tests`, `/help`, etc.)
* Use Cases
...
* Best Practices
	...
	* Use Copilot **as an assistant, not a replacement** :[^1]
...
[^1]: The intended roles AI should play: Treat it as a collaborative partner—an _assistant_, _co-worker_, _helper_, _coach_, or _adviser_—not a _contractor_ to whom you completely delegate your tasks and offload your responsibilities. →「0–1 的過程要靠自己的創造力」
