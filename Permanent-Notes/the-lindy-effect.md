...
1. Ancient philosophies (e.g., Stoicism) have lasted thousands of years and are likely to persist.
2. Technologies like the wheel or writing have endured for millennia.
3. Institutions such as universities or religions that have survived for centuries are likely to continue.

---

# Value tends to concentrate

A small percentage of ideas or resources (the “Lindy” ones) create most of the lasting impact—echoing [the Pareto Principle](the-pareto-principle.md) (0.1% of resources/ideas create 90% of the value).
