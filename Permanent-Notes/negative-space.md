...
The famous [FedEx logo](https://www.reddit.com/r/DesignPorn/comments/wmsnxh/i_never_noticed_the_arrow_the_negative_space/), for example, uses negative space to form an arrow between the E and the x, subtly reinforcing the idea of movement and direction.

Another classic example is the [Rubin vase (魯賓之盃)](https://www.google.com/search?q=Rubin+vase), an optical illusion where the negative space around a central vase shape can also be perceived as two faces in profile.
