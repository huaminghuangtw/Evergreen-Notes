...
AI tools are a force multiplier. **Not for code generation** [^1], but for the hardest part of software development: learning new things, and _applying them appropriately_.

---

**Never consume “LLM copypasta” without scrutiny.** [^2] Always validate the information and think critically using your own understanding.
...
A good LLM serves as a great groove-greaser / a productivity catalyst—helping you dive into focused work (e.g., boilerplates) or more informed research faster. It’s invaluable for filling in the gaps. [^3]
...
**Don’t use it solely to gather information.** Treat it as a personalized learning companion/tutorial to explore ideas and deepen your understanding of key concepts. Be sure to take thoughtful notes along the way.
...
* [Best Practices](https://code.visualstudio.com/docs/copilot/copilot-tips-and-tricks)
	...
	* Use Copilot **as an assistant, not a replacement** :[^5] [^6]
