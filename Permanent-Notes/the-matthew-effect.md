...
**The Matthew Effect (馬太效應)** describes the phenomenon where initial advantages tend to accumulate over time, leading to [The Winner-Take-All Effects](the-winner-take-all-effects.md).

The term comes from the biblical verse in the [Gospel of Matthew](https://www.google.com/search?q=Gospel+of+Matthew):
...
* **Feedback Loops:** Success breeds further success, while disadvantage can [compound](the-compounding-effect.md) into greater disadvantage.
...
* Popular platforms attract more users, which in turn makes them even more popular ([The Network Effect](https://www.google.com/search?q=The+Network+Effect)).
