...
While alcohol is sometimes used as a “[nightcap](https://www.google.com/search?q=nightcap)” [^1] to induce drowsiness, it actually **ruins the [quality of your sleep](sleep.md) and reduces the amount of restorative REM sleep**. [^2] This can result in feeling unrefreshed the next day, even if you slept for a normal duration.
