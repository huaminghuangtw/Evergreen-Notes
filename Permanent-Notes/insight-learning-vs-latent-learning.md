...
| -------------- | -------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| **Definition** | Sudden, [“aha!”](the-eureka-effect.md) solution to a novel problem using past knowledge                                    | Hidden learning that occurs without reinforcement, shown when motivated                                              |
| **Mechanism**  | Rearranging or combining past experiences in a new way to solve a problem (cognitive restructuring)                        | Passive acquisition through exploration/observation, not immediately shown (hidden knowledge stored for future use). |
