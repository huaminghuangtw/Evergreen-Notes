...
* 筆記間必須彼此連貫 (coherent) 而非彼此獨立 (independent)
	* 任何一則完整、簡潔、準確的「筆記」，應該具備的元素：基於科學的事實、思考過後的想法、可被檢驗的文獻。
	* 最重要的是，它代表一個擁有前後文的完整脈絡，而且不會隨著時間而失去它的效用 (Timeless)。
* 筆記不是為了把知識做成標本，而是為了讓它在你的生命裡重生。就像植物的「嫁接」，我們把一個知識點從別人的書裡剪下來（舊脈絡），然後接枝到自己的生命樹上（新脈絡）。
	* 不是單純「蒐集想法」，而是專注在「發展新想法」(Idea Emergence)
	* 不要求「記得」，而是求「理解」
